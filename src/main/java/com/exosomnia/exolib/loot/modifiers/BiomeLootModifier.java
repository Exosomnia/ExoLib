...
public class BiomeLootModifier extends LootModifier {

    public static final Supplier<Codec<BiomeLootModifier>> CODEC = Suppliers.memoize(() -> RecordCodecBuilder.create(codec -> codecStart(codec).apply(codec, BiomeLootModifier::new)));
    ...
    public BiomeLootModifier(LootItemCondition[] conditions) {
    ...
    protected @NotNull ObjectArrayList<ItemStack> doApply(ObjectArrayList<ItemStack> generatedLoot, LootContext context) {
        ...
        ResourceLocation biomeResource = level.registryAccess().registryOrThrow(Registries.BIOME).getKey(lootBiome.get());
