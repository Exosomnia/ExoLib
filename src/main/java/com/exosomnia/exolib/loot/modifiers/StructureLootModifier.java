...
public class StructureLootModifier implements IGlobalLootModifier {

    public static final Supplier<MapCodec<StructureLootModifier>> CODEC = Suppliers.memoize(() -> RecordCodecBuilder.mapCodec(instance -> instance.point(new StructureLootModifier())));
