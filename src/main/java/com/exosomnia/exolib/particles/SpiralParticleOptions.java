...
public class SpiralParticleOptions implements ParticleOptions {

    public static final Codec<SpiralParticleOptions> CODEC =
            Codec.FLOAT.listOf().xmap(
                    floats -> new SpiralParticleOptions(floats.get(0), floats.get(1), floats.get(2), floats.get(3)),
    ...
    public SpiralParticleOptions(float red, float green, float blue, float scale) {
        this.red = red;
        this.green = green;
        this.blue = blue;
        this.scale = scale;
    ...
    public ParticleType<?> getType() {
        return ExoLib.SPIRAL_PARTICLE.get();
    }
    ...
    public static final Deserializer<SpiralParticleOptions> DUMMY_DESERIALIZER =
            new Deserializer<>() {
                @Override
                public SpiralParticleOptions fromCommand(ParticleType<SpiralParticleOptions> type,
                                                         StringReader reader) {
                ...
                @Override
                public SpiralParticleOptions fromNetwork(ParticleType<SpiralParticleOptions> type,
